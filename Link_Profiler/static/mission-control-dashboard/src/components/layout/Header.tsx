...
const Header: React.FC<HeaderProps> = ({ toggleSidebar }) => {
  ...
  return (
    <header className="bg-nasa-gray text-white p-4 flex justify-between items-center shadow-md">
      <div className="flex items-center">
        ...
        <span className="ml-6 text-sm text-nasa-light-gray flex items-center">
          <span className="w-2 h-2 bg-red-500 rounded-full mr-1 animate-pulse"></span> LIVE
        </span>
