...
async def serve_dashboard_spa(request: Request, path: str):
    ...
    if hasattr(request.state, 'is_api_request') and request.state.is_api_request:
        ...
        # Do NOT raise HTTPException here. Let FastAPI's default routing handle 404 for unmatched API routes.
        # This function should only serve SPAs or redirect.
        pass # Continue to check for dashboard requests
